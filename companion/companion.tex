...
\section{Notation}
    ...
    \begin{flalign*}
        ...
        \boldsymbol{X} &= \begin{pmatrix} x^{(0)}_1 & ... & x^{(N)}_1 \\ ... & ... & ... \\ x^{(0)}_M & ... & x^{(N)}_M \end{pmatrix} \text{: dataset consisting of $N$ data points and $M$ features} & \\
        \overline{\boldsymbol{X}} &= \begin{pmatrix} 1 & ... & 1 \\ x^{(0)}_1 & ... & x^{(N)}_1 \\ ... & ... & ... \\ x^{(0)}_M & ... & x^{(N)}_M \end{pmatrix} \text{: concatenation of a vector of 1's with the matrix } \boldsymbol{X} & \\
        ...
        \boldsymbol{x}^* &= \text{: test input / unknown input } & \\
        \boldsymbol{y}^* &= \text{: predicted output} & \\
